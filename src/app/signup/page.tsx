...
import { AlertCircle, CheckCircle, Loader2, ArrowLeft, Terminal, ChevronRight, UserPlus, Eye, EyeOff } from "lucide-react";
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-sm font-medium">
              Initialize your professional identity node
            </p>
          </div>
          ...
          {success ? (
            <div className="text-center space-y-6 py-4">
              ...
              <Link
                href="/login"
                className="inline-block w-full px-6 py-4 bg-blue-600 hover:bg-blue-700 text-white font-black text-xs uppercase tracking-[0.2em] rounded-xl transition-all shadow-lg hover:shadow-xl"
              >
                Proceed_to_Login
              </Link>
            </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <div className="space-y-2">
                <label htmlFor="password" className="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">
                  <Terminal className="w-3 h-3" />
                  Secure_Password
                </label>
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 text-center">
            <p className="text-slate-500 text-xs font-medium">
              ...
              <Link href="/login" className="text-blue-600 hover:text-blue-700 font-black uppercase tracking-wider ml-1">
                Access_Portal
              </Link>
            </p>
          </div>
